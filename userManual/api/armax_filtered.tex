...
($i = 1,\ldots,9$), and the ARMAX criterion is minimized on the
filtered data.  The cutoff increases from $0.1\pi$ to $0.9\pi$,
progressively widening the passband and reshaping the cost function
to reduce the attraction of undesirable local minima before the
estimate is refined on the original data.
