...
\begin{equation}
  ...
  \qquad \beta_i = \frac{i}{1000},\quad i=1,\ldots,1000,
...
\begin{table}[ht]
  ...
  \begin{tabular}{lp{0.55\columnwidth}}
    \toprule
    Version & \texttt{pysib} v0.2.2~\citep{pysib2026} \\
    License & MIT \\
...
contrast, exhibit a visible bias, for example, a mean \(b_1\) of \(1.044\)
...
adaptive filter schedules or filter families beyond first-order low-pass and
Butterworth designs.  Finally, broader comparisons with other Python
